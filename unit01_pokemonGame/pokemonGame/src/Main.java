...
public class Main {
    ...
    {   
        //two move list tiers
        Moves [] listA  =  { new Moves("Wing Attack",35,35,"Flying"),
                        new Moves("Quick Attack", 30, 40, "Normal"),
                        new Moves("Bite", 25, 60, "Dark"),
                        new Moves("Mean Look", 5, 0, "Normal")};

        Moves [] listB  =  { new Moves("Astonish",15,30,"Ghost"),
                        new Moves("Quick Attack", 30, 40, "Normal"),
                        new Moves("Bite", 25, 60, "Dark"),
                        new Moves("Ice Beam", 20, 30, "Ice")};
